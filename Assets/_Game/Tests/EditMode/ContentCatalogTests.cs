...
namespace IdleMedievalLegends.Tests.EditMode
{
    public sealed class ContentCatalogTests
    {
        ...
        public void Catalog_DemoDefinitions_IsValid()
        {
            ...
            Assert.That(report.Summary.ItemCount, Is.EqualTo(8));
            Assert.That(report.Summary.EquipmentCount, Is.EqualTo(3));
            Assert.That(report.Summary.MaterialCount, Is.EqualTo(5));
            Assert.That(report.Summary.RecipeCount, Is.EqualTo(4));
        }
